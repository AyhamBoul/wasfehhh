  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _PNavItem(icon: Icons.home_rounded, label: 'Home',
              active: activeIndex == 0, onTap: onHome),
          _PNavItem(icon: Icons.calendar_month_rounded, label: 'Calendar',
              active: activeIndex == 1, onTap: onCalendar),
          _PNavItem(icon: Icons.local_pharmacy_rounded, label: 'Pharmacy',
              active: activeIndex == 2, onTap: onPharmacy),
          _PNavItem(icon: Icons.logout_rounded, label: 'Logout',
              onTap: onLogout),
        ],
      ),
    );
